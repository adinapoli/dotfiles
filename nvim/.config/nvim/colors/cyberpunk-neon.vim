...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi CursorLine ctermbg=201 ctermfg=201 cterm=NONE guibg=#181a1f guifg=NONE gui=NONE
    hi LineNr ctermbg=NONE ctermfg=44 cterm=NONE guibg=NONE guifg=#0abdc6 gui=NONE
    hi CursorLineNr ctermbg=201 ctermfg=201 cterm=NONE guibg=#181a1f guifg=#ea00d9 gui=NONE
    ...
    hi Search ctermbg=201 ctermfg=NONE cterm=bold guibg=#711c91 guifg=NONE gui=bold
